        ...
        <div class="relative">
            ...
            <section class="mx-auto grid min-h-[calc(100svh-5rem)] max-w-6xl content-center items-center gap-14 px-6 py-12 lg:grid-cols-[1.1fr_1fr] lg:gap-8">
                <div>
                    ...
                    <p class="mt-7 max-w-md animate-fade-up text-lg leading-relaxed [animation-delay:200ms]">
                        Yaarpool matches seats right where you already talk. No new app needed.
                    </p>
            ...
            <section id="how" class="mx-auto max-w-6xl px-6 py-20">
                ...
                <div class="mt-14 grid gap-10 md:grid-cols-3 md:gap-6">
                    @php
                        $steps = [
                            ['1', '-rotate-2', 'bg-saffron', 'Add the bot to your group chat', 'Invite Yaarpool like any other contact. Takes about 30 seconds.'],
                            ['2', 'rotate-1', 'bg-emerald-400', 'Type your route and time', 'Text it naturally — "Driving to BKC tomorrow at 9 AM, 2 seats free."'],
                            ['3', '-rotate-1', 'bg-saffron', 'Match with a friend instantly', 'The bot connects drivers and passengers already in your group.'],
                        ];
                    @endphp
                ...
                <div class="mt-14 grid gap-8 sm:grid-cols-2 lg:grid-cols-3 lg:gap-6">
                    @php
                        $features = [
                            ...
                            ['🚙', 'rotate-1', 'bg-emerald-100', 'Offer empty slots', 'Driving anyway? Tell the group your route and let people hop in to split costs.'],
