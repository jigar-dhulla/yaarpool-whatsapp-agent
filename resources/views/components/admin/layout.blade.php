        ...
        <div class="mx-auto max-w-5xl px-6 py-10">
            <nav class="flex flex-wrap items-center gap-4 rounded-3xl border border-ink/10 bg-white px-5 py-3.5 shadow-card">
                ...
                <div class="flex items-center gap-1">
                    ...
                    <a href="{{ route('rides.index') }}" class="rounded-full px-4 py-2 text-sm font-bold transition {{ request()->routeIs('rides.*') ? 'bg-emerald-500 text-white' : 'opacity-70 hover:bg-ink/5 hover:opacity-100' }}">Rides</a>
